...
public class GNUSubprocessEngineWindow extends SubprocessEngineWindow{
	public GNUSubprocessEngineWindow(GNUSubprocessEngine e) throws IOException{
		super(e);
	}
	public GNUSubprocessEngineWindow(GNUSubprocessEngine e,boolean autoDisplay) throws IOException{
		super(e,autoDisplay);
	}	
