...
echo ======================================================================START
@echo on
%JAVA_BIN%\javac -d tempCompiled -classpath .;junit.jar;%DERBY_HOME%\lib\*.jar;%LIB%\*;%JGRAPH%\jgrapht-jdk1.6.jar;tempCompiled com\declarativa\interprolog\*.java com\declarativa\interprolog\util\*.java com\declarativa\interprolog\gui\*.java com\declarativa\interprolog\examples\*.java com\xsb\interprolog\*.java se\umu\uikm\argbuilder\gui\layout\*.java
echo ======================================================================END
...
copy %DERBY_HOME%\lib\derby.jar tempCompiled\lib\derby.jar
copy %LIBS%\*.jar tempCompiled\lib
...
@echo on
%JAVA_BIN%\jar cvfe ..\interprolog.jar %DERBY_HOME%\lib\derby.jar %LIBS%\*.jar %JGRAPH%\jgrapht-jdk1.6.jar *
