/* /cygdrive/c/XSBSYS/XSBDEV/XSBtest/XSB/config/i686-pc-cygwin-mt/xsb_config.h.  Generated from def_config_mnoc.in by configure.  */
/*  @configure_input@
**
...
#define FULL_CONFIG_NAME "i686-pc-cygwin-mt"
